...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    dist: 'dist',
    filename: 'ui-bootstrap-fontawesome',
    filenamecustom: '<%= filename %>-custom',
    meta: {
      modules: 'angular.module("ui.bootstrap.fontawesome", [<%= srcModules %>]);',
      tplmodules: 'angular.module("ui.bootstrap.fontawesome.tpls", [<%= tplModules %>]);',
      all: 'angular.module("ui.bootstrap.fontawesome", ["ui.bootstrap.fontawesome.tpls", <%= srcModules %>]);',
      cssInclude: '',
  ...
  grunt.registerTask('makeRawFilesJs', function () {
    ...
    genRawFilesJs(grunt, jsFilename, _.flatten(grunt.config('concat.dist.src')),
